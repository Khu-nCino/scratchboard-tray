...
console.log("Zipping...")
console.log(execSync('ditto -c -k --sequesterRsrc --keepParent "'+appPath+'" "dist/'+info.name+'-'+info.version+'-mac.zip"').toString());
console.log("Finished zipping!");

console.log("Collect data...");
var blockmap = JSON.parse(execSync('./node_modules/app-builder-bin/mac/app-builder blockmap -i dist/'+info.name+'-'+info.version+'-mac.zip -o dist/th.zip').toString());
